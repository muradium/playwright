...
### option: APIRequestContext.delete.certificateOptions = %%-js-python-fetch-option-certificateoptions-%%
* since: v1.26
...
### option: APIRequestContext.fetch.certificateOptions = %%-js-python-fetch-option-certificateoptions-%%
* since: v1.26
...
### option: APIRequestContext.get.certificateOptions = %%-js-python-fetch-option-certificateoptions-%%
* since: v1.26
...
### option: APIRequestContext.head.certificateOptions = %%-js-python-fetch-option-certificateoptions-%%
* since: v1.26
...
### option: APIRequestContext.patch.certificateOptions = %%-js-python-fetch-option-certificateoptions-%%
* since: v1.26
...
### option: APIRequestContext.post.certificateOptions = %%-js-python-fetch-option-certificateoptions-%%
* since: v1.26
...
### option: APIRequestContext.put.certificateOptions = %%-js-python-fetch-option-certificateoptions-%%
* since: v1.26
